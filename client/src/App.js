...
function App() {
  ...
  // const [itemNoibat, setItemNoibat] = useState([])
    ...
    <div id='App'>
      ...
      <div className='app-home-container'>
        ...
        <div className='category-noibat' style={{ backgroundColor: '#FAFAFA', height: 350, marginTop: 10 }}>
          <p style={{ textAlign: 'center', fontWeight: 50, margin: 0, backgroundColor: '#94baf3', borderRadius: 3, paddingTop: 10, paddingBottom: 10 }}>SAN PHAM NOI BAT</p>
